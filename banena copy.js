...
window.addEventListener("onWidgetLoad", function (obj) {
  ...
  if (skin === "none" || !skin) {
    ...
    bodyDraw.src = `https://tiennguyen99.github.io/se-widgets/assets/Laphipii/Laphipii.png`;
  }
  ...
  switch (listener) {
    ...
    case "subscriber-latest":
      if (event.bulkGifted) {
        ...
        setFrame(48, 63, animationSpeed);
        playAnimation();
      }
      break;
    case "message":
      if (event.data.text.includes("!pat")) setFrame(160, 174, animationSpeed);
      if (event.data.text.includes("!feed")) setFrame(176, 202, animationSpeed);
  }
